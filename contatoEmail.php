...
<!-- C:\xampp\php -php.ini- alterar variavel sendmail_path: 
    ...
    reestartar o server xamp
    A primeira vez que rodei o  gmail bloqueou minha tentativa de conexão apartir do localhost.
    para evitar esse erro: configurações de segurança (https://myaccount.google.com/security)
    Apps com acesso a conta > Permitir aplicativos menos seguros: ATIVADA
 -->
